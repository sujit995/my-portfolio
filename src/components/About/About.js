          ...
          <div className="about__details-container">
            ...
            >
              <Link to="/about/intro">
                ...
                <p>
                  I am <span>Sujit Mishra.</span> <br /> Highly passoinate
            ...
            >
              <Link to="/about/experience">
                ...
                <p>
                  ...
                  highly responsive frontend of websites using React.js and Nextjs.
                </p>
              </Link>
            </div> */}
            <div
            ...
            >
              <Link to="/about/internships">
                ...
                <ul>
                  <li>
                    <span>IWEBCODE</span> - Front-end Developer{" "}
                  </li>
                </ul>
              </Link>
            </div>
            ...
            >
              <Link to="/about/graduation">
                ...
                <h2>
                  M<span>aster in Computer Application</span>
                </h2>
                <p>
                  <span>United School of Business Management </span>
                  <br />
                  I have completed MCA in 2019 from USBM College.
                </p>
              </Link>
            </div>
          </div>
